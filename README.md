...
- Был разработан основной функционал приложения. Планируется работа с localStorage (сохранение выбранных героев пользователем), доработка страницы с подробной информацией о герое, доработка не существующей страницы (404).
